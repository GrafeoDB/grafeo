//! solvOR-compatible adapter for Graphos.
//!
//! This module provides an adapter that exposes Graphos algorithms
...
impl PySolvORAdapter {
    ...
    pub fn new(db: Arc<RwLock<GraphosDB>>) -> Self {
        Self { db }
    }
}
        ...
        let result = match method {
            ...
            "bellman_ford" => {
                ...
                if bf_result.has_negative_cycle {
                    return Err(PyGraphosError::InvalidArgument(
            ...
            _ => {
                return Err(PyGraphosError::InvalidArgument(format!(
