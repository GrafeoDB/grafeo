"""Cypher implementation of NetworkX comparison tests.
...
class TestCypherNetworkXComparison(BaseNetworkXComparisonTest):
    """Cypher implementation of NetworkX comparison tests.

    Note: Algorithms are accessed via db.algorithms.*, not via Cypher queries.
    Cypher is used for graph setup and verification only.
    """
...
class TestCypherNetworkXBenchmark(BaseNetworkXBenchmarkTest):
    """Cypher implementation of NetworkX performance comparison tests.
